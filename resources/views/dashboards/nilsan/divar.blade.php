        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel17"> افزودن آگهی  </h4>
                ...
                <div class="modal-body">
                    ...
                    <form style="vertical-align:center;text-align:center" enctype="multipart/form-data" method="post"
                          action="/divar" class="form form-horizontal form-bordered striped-rows">
                        @csrf
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div style="text-align: center!important;" class="modal-header">
                            <h4 style="text-align: center!important;" class="modal-title" id="ReferralsTdl{{ $phoneBook->id }}">جزییات آگهی  </h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
    ...
    @foreach($Divars as $phoneBook)
        <div style="font-family:Byekan" class="modal fade text-left" id="showDataModalEdit{{ $phoneBook->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel{{ $phoneBook->id }}" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div style="text-align: center!important;" class="modal-header">
                        <h4 style="text-align: center!important;" class="modal-title" id="showDataModalEdit{{ $phoneBook->id }}">آگهی </h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div  style=" direction: rtl;" class="modal-body">
                        ...
                        <form style="vertical-align:center;text-align:center" method="post" action="/divar/update/{{ $phoneBook->id }}"  enctype="multipart/form-data" class="form form-horizontal form-bordered striped-rows">
                            @csrf
                            <div class="form-body">
                                        ...
                                        @foreach($Divars as $archive)
                                            <tr>
                                                ...
                                                <td style="text-align: center;vertical-align: center;font-size: 20px;color: #3BAFDA; " >
                                                    <a target="_blank" href="{{ $archive->file }}"> {!! $archive->file !== "storage/Divars/nothing" ? "<i class='ft-file-text' ></i>" : "" !!} </a>
                                                </td>
                                                ...
                                                <td style="text-align:center;color: #3BAFDA">
                                                    ...
                                                    <a onclick="return confirm('آیا برای حذف اطمینان دارید؟');"
                                                       href="/divar/delete/{{ $archive->id }} "><i
